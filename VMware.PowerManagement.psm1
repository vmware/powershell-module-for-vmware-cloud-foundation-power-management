...
#     Try {
#         Write-PowerManagementLogMessage -Type INFO -Message "Starting the call to the Get-VsanClusterMember cmdlet." -Colour Yellow
#         $checkServer = (Test-NetConnection -ComputerName $server -Port 443).TcpTestSucceeded
#         if ($checkServer) {
#             Write-PowerManagementLogMessage -Type INFO -Message "Connecting to '$server'..."
#             if ($DefaultVIServers) {
...
#             Connect-VIServer -Server $server -Protocol https -User $user -Password $pass | Out-Null
#             if ($DefaultVIServer.Name -eq $server) {
#                 Write-PowerManagementLogMessage -Type INFO -Message "Connected to server '$server' and checking whether vSAN cluster members are present..."
...
#     }
#     Finally {
#         Write-PowerManagementLogMessage -Type INFO -Message "Completed the call to the Get-VsanClusterMember cmdlet." -Colour Yellow
#     }
# }
...
#     Try {
#         Write-PowerManagementLogMessage -Type INFO -Message "Starting the call to the Get-VMwareToolsStatus cmdlet." -Colour Yellow
#         if (( Test-NetConnection -ComputerName $server -Port 443 ).TcpTestSucceeded) {
#             Write-PowerManagementLogMessage -Type INFO -Message "Connecting to '$server'..."
#             Connect-VIServer -Server $server -Protocol https -User $user -Password $pass | Out-Null
#             if ($DefaultVIServer.Name -eq $server) {
#                 Write-PowerManagementLogMessage -type INFO -Message "Connected to server '$server' and trying to get the VMware Tools status."
...
#     }
#     Finally {
#         Write-PowerManagementLogMessage -Type INFO -Message "Completed the call to the Get-VMwareToolsStatus cmdlet." -Colour Yellow
#     }
# }
...
#     Try {
#         Write-PowerManagementLogMessage -Type INFO -Message  "Starting the call to the Test-WebUrl cmdlet." -Colour Yellow
...
#     }
#     Finally {
#         Write-PowerManagementLogMessage -Type INFO -Message "Completed the call to the Test-WebUrl cmdlet." -Colour Yellow
#     }
# }
...
#     Try {
#         Write-PowerManagementLogMessage -Type INFO -Message "Starting the call to Set-VAMIServiceStatus cmdlet." -Colour Yellow
#         if ((Test-NetConnection -ComputerName $server -Port 443).TcpTestSucceeded) {
#             Write-PowerManagementLogMessage -Type INFO -Message "Connecting to '$server'..."
...
#                     Write-PowerManagementLogMessage -Type INFO -Message "Service $service is already set to '$requestedState'." -Colour Green
#                 }
#                 else {
#                     if ($action -eq "START") {
...
#     Try {
#         Write-PowerManagementLogMessage -Type INFO -Message "Starting the call to the Set-vROPSClusterState cmdlet." -Colour Yellow
#         $checkServer = (Test-NetConnection -ComputerName $server -Port 443).TcpTestSucceeded
#         if ($checkServer) {
#             Write-PowerManagementLogMessage -Type INFO -Message "Connecting to '$server'..."
...
#                     Write-PowerManagementLogMessage -Type INFO -Message "The vRealize Operations Manager cluster is set to $mode state, waiting for the operation to complete..."
#                     Do {
#                         Start-Sleep 5
...
#     }
#     Finally {
#         Write-PowerManagementLogMessage -Type INFO -Message "Completed the call to the Set-vROPSClusterState cmdlet." -Colour Yellow
#     }
# }
...
#     Try {
#         Write-PowerManagementLogMessage -Type INFO -Message "Starting the call to the Request-PowerStateViaVRSLCM." -Colour Yellow
#         Write-PowerManagementLogMessage -Type INFO -Message "Getting the environment ID for '$product' from vRealize Suite Lifecycle Manager."
...
#         }
#         else {
#             Write-PowerManagementLogMessage -Type ERROR -Message "Cannot  $mode for $product due to response." -Colour Red
#         }
...
#         }
#         Write-PowerManagementLogMessage -Type INFO -Message "Completed the call to the Request-PowerStateViaVRSLCM cmdlet." -Colour Yellow
#     }
#     Catch {
#         Debug-CatchWriterForPowerManagement -object $_
#     }
...
#             Write-PowerManagementLogMessage -Type INFO -Message "racadm.exe is present in $exe_path." -Colour Yellow
#             $default_path = $exe_path
#         }
#         elseif (Test-path  $default_path) {
#             Write-PowerManagementLogMessage -Type INFO -Message "racadm.exe is present in the default path." -Colour Yellow
#         }
#         else {
#             Write-PowerManagementLogMessage -Type ERROR -Message "racadm.exe is not present in $exe_path or the default path $default_path." -Colour Red
#         }
...
#             Write-PowerManagementLogMessage -Type INFO -Message "Powering host $ilo_ip on is successfully initiated." -Colour Yellow
...
#     }
#     Finally {
#         Write-PowerManagementLogMessage -Type INFO -Message "Completed the call to the PowerOn-EsxiUsingILO cmdlet." -Colour Yellow
#     }
# }
